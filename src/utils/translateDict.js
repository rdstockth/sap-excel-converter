...
export const _dict = Object.freeze({
  ...
  "ไม่ชัด":{en:"unclear print",t:"S"},"กระดาษติด":{en:"paper jam",t:"S"},
  ...
  "ปริ้นเตอร์":{en:"printer",t:"C"},"ปลิ้นเตอร์":{en:"printer",t:"C"},
...
const _normRules = [
  ...
  [/alarm|อาราม|อะลาม/gi, 'เออเร่อ'], // ยุบรวม Alarm ให้เป็น Error
  ...
  [/สวตว์|สวิท|สวิต|สวิทซ์|สวิตช์|สวิทส์/g, 'สวิทช์'],
  ...
  [/ตระแกรง/g, 'ตะแกรง'],
  [/คัปปลิง|คัปปิ้ง|คัปปิง|ยอย/g, 'คัปปลิ้ง'],
  ...
  [/เอนโค้เดอ(?=[^ร]|$)|เอนโค้ดเดอ(?=[^ร]|$)|encoder/gi, 'เอ็นโค้ดเดอร์'],
  [/พีแอลซี/g, 'PLC'],
  ...
  // ==========================================
  // 💨 Pneumatics & Vacuums (ระบบลมและสูญญากาศ)
  // ==========================================
  ...
  // ==========================================
  // 🏭 Facility & Optics (ระบบประกอบอาคารและงานเลนส์)
  // ==========================================
  [/ชิลเลอ|ชิวเลอร์|chiller/gi, 'ชิลเลอร์'],
  [/บอยเลอ|หม้อต้มน้ำ|boiler/gi, 'หม้อต้ม'],
  [/ฮีตเตอ|ฮีดเตอร์|heater/gi, 'ฮีตเตอร์'],
  [/ท่อน้ำทิ้ง|ท่อเดรน/g, 'ท่อน้ำทิ้ง'],
  [/เลนส|เลน|ลนส์/g, 'เลนส์'],
  [/เคลิอบ|เครือบ|เคลืบ|โค้ทติ้ง/g, 'เคลือบ'],
  [/พอลลิช|โพลิช|polish/gi, 'ขัด'],

  // ==========================================
  // 🛣️ Conveyor & Motion
  // ==========================================
  [/คอนเวเยอ(?=[^ร]|$)|คอนเวนเยอร์/g, 'คอนเวเยอร์'],
  [/สายพานหยุด/g, 'สายพานไม่หมุน'],
  ...
  // ==========================================
  // 🔴 ปัญหาที่พบบ่อย (Common Symptoms)
  // ==========================================
  ...
  // ==========================================
  // 🧹 Text Normalize (จัดการอักขระและช่องว่าง - ต้องไว้ล่างสุด)
  // ==========================================
  // ดักพวกพิมพ์ลากยาว เช่น ร้อนนนนนน -> ร้อนน, ติดดดด -> ติดด (ลด Noise)
  [/([\u0E00-\u0E7F])\1{2,}/g, '$1$1'],
  // ยุบช่องว่างหลายๆ เคาะให้เหลือเคาะเดียว
  [/\s+/g, ' '],
]
